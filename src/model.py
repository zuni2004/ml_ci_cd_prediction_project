...
BASE_DIR = r"D:\ml_ci_cd_prediction_project"
OUTPUT_DIR = os.path.join(BASE_DIR, "src", "saved_models")
os.makedirs(OUTPUT_DIR, exist_ok=True)

CONFIG = {
    "train_file": os.path.join(BASE_DIR, "data\processed_data", "train_processed.csv"),
    "test_file": os.path.join(BASE_DIR, "data\processed_data", "test_processed.csv"),
